          ...
          <div>
            <form action="" class="form-horizontal" role="form" id="order-form">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9 col-md-7">
                  <textarea name="remark" id="" rows="3" class="form-control"></textarea>
                </div>
              </div>
  ...
  <script>
    $(document).ready(function () {
        ...
        $('.btn-remove').click(function () {
            ...
            // closest() 方法可以获取到匹配选择器的第一个祖先元素，在这里就是当前点击的 移除 按钮之上 <tr> 标签
            // data('id') 方法可以获取到之前设置的 data-id 属性的值，也就是对应的 SKU id
        ...
        $('#select-all').change(function () {
            ...
            // 对于已经下架的商品我们不希望对应的勾选框会被选中，因此需要加上 :not([disabled]) 这个条件
