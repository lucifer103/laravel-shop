        ...
        <div class="card-body product-info">
          <div class="row">
            ...
            <div class="col-7">
              ...
              @if($product->type === \App\Models\Product::TYPE_CROWDFUNDING)
                <div class="crowdfunding-info">
                  ...
                  <div class="total-amount"><span
                      class="symbol">￥</span>{{ $product->crowdfunding->total_amount }}
                  </div>
                  {{-- Bootstrap 的进度条组件 --}}
                  <div class="progress">
              ...
              @else
                {{-- 原普通商品模块开始 --}}
                <div class="price"><label for="">价格</label><em>￥</em><span>{{ $product->price }}</span>
                </div>
              ...
              <div class="buttons">
                ...
                @elseif ($product->type === \App\Models\Product::TYPE_SECKILL)
                  ...
                  @if (Auth::check())
                    ...
                    @endif
                  @else
                    <a href="{{ route('login') }}" class="btn btn-parmary">请先登录</a>
                  @endif
                  {{-- 秒杀商品下单按钮结束 --}}
                @else
          ...
          <div class="product-detail">
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tan-pane fade" id="product-reviews-tab">
                {{-- 评论列表开始 --}}
