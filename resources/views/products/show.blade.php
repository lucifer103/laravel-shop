        ...
        <div class="card-body product-info">
          <div class="row">
            ...
            <div class="col-7">
              ...
              <div class="buttons">
                ...
                <button class="btn btn-primary btn-add-card">加入购物车</button>
              </div>
            </div>
          </div>
          <div class="product-detail">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                <a href="#product-detail-tab" class="nav-link active" aria-controls="product-detail-tab" role="tab" data-toggle="tab" aria-selected="true">商品详情</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tan-pane" id="product-reviews-tab">
